      ...
      <div className="container-fluid">
        <div className="well">
          ...
          <div className="filters">
            {
              inout == 'in' ? <button className="btn btn-success"  onClick={() => this.type()}>Incoming</button> : null
            }
            {
              inout == 'out' ? <button className="btn btn-danger"  onClick={() => this.type()}>Outgoing</button> : null
            }
            {
              type == 'Cabinets' ? <button className="btn btn-info" onClick={() => this.product()} >Cabinets</button> : null
            }
            {
              type == 'Units' ? <button className="btn btn-warning" onClick={() => this.product()} >Units</button> : null
            }
            {
          ...
          <div className="mb-20"></div>
          {
            step == 4 ? <div className="productCount">
              ...
              <div style={{'width': '100%', 'textAlign':'center'}}>
                ...
                <button className="btn btn-primary"  onClick={() => this.product()} >Cancel</button>
              </div>
            </div> : null
          }
        </div>
